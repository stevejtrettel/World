...
let springCubeSim = new SpringCube(resolution, springParameters, springConditions, collision, globals.renderer);
springCubeSim.setIterations(20);

export { SpringCube };

export default  springCubeSim;
