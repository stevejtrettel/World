...
const grid2D_Coord1_springForce = grid2D_Coord('springForce',1);
const grid2D_Coord2_springForce = grid2D_Coord('springForce',2);

let grid2D_Diag1_springForce = grid2D_Diag('springForce', 1);
let grid2D_Diag2_springForce = grid2D_Diag('springForce', 2);
