...
import bhOctahedron from "./bhOctahedron.js";
...
class Extremal{
    constructor(){
        ...
        this.bh = new MPBH(bhOctahedron);

        this.iniCond = new State( new Vector3(-2,-2,-2),new Vector3(1,0.9015,0));
    ...
    addToUI(ui){
        ...
        ui.add(params, 'vy',-1.5,1.5,0.001).onChange(function(value){
            iniCond =  new State( new Vector3(-2,-2,-2),new Vector3(1,0.446+0.01*value,0));
