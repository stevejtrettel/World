...
class RiemannSumPlotter{
    ...
    addToUI(ui){
        ...
        // add a *button* that calls your method
    ...
    tick(time,dTime){
        ...
        this.params.currentN += 10*dTime;
        this.params.N = Math.floor(this.params.currentN);
        // this.params.time += dTime;
        this.riemannSum.update(this.params);
        this.riemannSum.setN(this.params.N);
        //
