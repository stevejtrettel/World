...
import Mercator from "../../../../code/items/maps/Mercator.js";


class MercatorMap{
    constructor() {
        this.map = new Mercator('./assets/earth.jpeg');
    ...
    addToUI(ui){
        ...
        ui.add(params,'toCyl',0,1,0.01).onChange(function(value){
            mercator.uniforms.toCyl.value = value;
        });
        ui.add(params,'toPlane',0,1,0.01).onChange(function(value){
            mercator.uniforms.toPlane.value = value;
        });
