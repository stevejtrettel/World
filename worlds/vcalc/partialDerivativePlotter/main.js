...
import PartialDerivativePlotter from "../../../common/items/vector-calculus/PartialDerivativePlotter.js";
...
function main(globalSettings) {
    ...
    let example = new PartialDerivativePlotter(world.renderer, params);
