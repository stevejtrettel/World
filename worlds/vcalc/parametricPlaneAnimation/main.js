...
import ParametricPlaneAnimation from "../../../code/vignettes/vector-calculus/ParametricPlaneAnimation.js";
...
function main(globalSettings) {
    ...
    let example = new ParametricPlaneAnimation(world.renderer);
