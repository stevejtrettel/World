...
import ParametricSurfaceAnimation from "../../../common/items/vector-calculus/ParametricSurfaceAnimation.js";
...
function main(globalSettings) {
    ...
    let example = new ParametricSurfaceAnimation(world.renderer,params);
