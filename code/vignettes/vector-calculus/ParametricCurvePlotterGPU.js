...
class ParametricCurvePlotterGPU {
    constructor(params=defaultParams) {
        ...
        this.curve = new ParametricCurve(this.buildGLSLEquation(),this.range,this.uniforms,this.curveColor,surfaceOptions,this.params.curveRad);
...
export default ParametricCurvePlotterGPU
